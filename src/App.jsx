        ...
        <Route
          ...
          element={
            <>
              ...
              />
              <main>
                <Pole1Header /> <Pole1Home /> <Pole1Livrable />{" "}
                <Pole1Objectif />
                <Contact />
              </main>
              <Footer />
          ...
          element={
            <>
              ...
              <main>
                ...
                <AproposSocratea /> <AproposLocal /> <Contact />
              </main>
              <Footer />
            </>
          }
          ...
          element={
            <>
              ...
              <main>
                ...
                <CabinetsDeroulement /> <CabinetsContact />
              </main>
              <Footer />
            </>
          }
        ...
        <Route
          ...
          element={
            <>
              ...
              />
              <main>
                <QuestionsHeader /> <FAQHome /> <FAQFootter />
              </main>
              <Footer />
            </>
          }
        ...
        <Route
          ...
          element={
            <>
              ...
              />
              <main>
                <ConfidentialiteHeader /> <ConfidentialiteHome />
              </main>
              <Footer />
            </>
          }
